 ...
 <img class="color"src="<?php echo get_stylesheet_directory_uri(); ?>/img/color2.png" alt="Colores">
  ...
  <h2>Te ofrecemos </h2>
   <div class="grid">
       ...
       <div class="col3">
           <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/utilizamos.png" alt="utlizamos">
           <p>Utilizamos refacciones originales
</p>
       </div>
       <div class="col3">
           <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/servicio.png" alt="servicio">
           <p>Servicio a Domicilio</p>
       </div>
       <div class="col3">
           <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/tv.png" alt="TV">
           <p>En taller, la revisión es gratis </p>
       </div>
       <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/paypal.png" alt="Paypal">
   </div>
     </div>
</section>
<section id="reparacion" class="template-section">
